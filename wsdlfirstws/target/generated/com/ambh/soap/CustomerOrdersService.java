 ...
 * 2018-12-01T23:39:19.340-03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "CustomerOrdersService",
                  wsdlLocation = "file:/home/andres/Stuff/learning-tests/JavaWebServices/wsdlfirstws/src/main/resources/CustomerOrders.wsdl",
                  targetNamespace = "http://soap.ambh.com/")
public class CustomerOrdersService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://soap.ambh.com/", "CustomerOrdersService");
    public final static QName CustomerOrdersPort = new QName("http://soap.ambh.com/", "CustomerOrdersPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/home/andres/Stuff/learning-tests/JavaWebServices/wsdlfirstws/src/main/resources/CustomerOrders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerOrdersService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/andres/Stuff/learning-tests/JavaWebServices/wsdlfirstws/src/main/resources/CustomerOrders.wsdl");
        }
        WSDL_LOCATION = url;
    }
