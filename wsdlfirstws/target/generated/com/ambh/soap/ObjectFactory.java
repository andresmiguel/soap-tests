 ...
 * generated in the com.ambh.soap package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrdersRequest_QNAME = new QName("http://soap.ambh.com/", "getOrdersRequest");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://soap.ambh.com/", "getOrdersResponse");
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://soap.ambh.com/", "createOrdersRequest");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://soap.ambh.com/", "createOrdersResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ambh.soap
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.ambh.com/", name = "getOrdersRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.ambh.com/", name = "getOrdersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.ambh.com/", name = "createOrdersRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.ambh.com/", name = "createOrdersResponse")
